...
final class RxStorageQRScanTests: XCTestCase {
    ...
    func testQRCodeScanPublicItem() throws {
        ...
        let qrContent = "http://localhost:3000/preview/item?id=test-public-item"
    ...
    func testQRCodeScanPrivateItemAuthenticated() throws {
        ...
        let qrContent = "http://localhost:3000/preview/item?id=test-private-item"
        let app = launchAppWithQRCode(qrContent)
    ...
    func testQRCodeScanPrivateItemAccessDenied() throws {
        ...
        let qrContent = "http://localhost:3000/preview/item?id=test-other-user-item"
        let app = launchAppWithQRCode(qrContent)
    ...
    func testQRCodeScanNonExistentItem() throws {
        ...
        let qrContent = "http://localhost:3000/preview/item?id=nonexistent-id"
        let app = launchAppWithQRCode(qrContent)
    ...
    func testQRCodeScanRelativePath() throws {
        ...
        let qrContent = "preview/item?id=test-public-item"
        let app = launchAppWithQRCode(qrContent)

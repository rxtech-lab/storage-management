      ...
      <div className="flex gap-2 overflow-x-auto pb-2 -mb-2 scrollbar-hide">
        ...
        {item.parent && (
          <Link href={`/items/${item.parent.id}`}>
            <div className="flex-shrink-0 flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary/80 border border-border/50 hover:bg-secondary transition-colors cursor-pointer">

...
Next.js full-stack admin app for storage management. Uses direct Turso/Drizzle database access and provides REST APIs for the iOS mobile app.
...
export async function createItemAction(data) {
  // Direct Drizzle queries, auto-revalidates cache
